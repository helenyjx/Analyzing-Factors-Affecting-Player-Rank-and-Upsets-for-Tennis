---
title: "Group Project Draft Report"
...
kable(mat1v2,row.names=TRUE,
      col.names=c("Estimate", "Standard Error", "Statistic",
                  "p-value"),format="html",booktabs=T,
...
kable(mat2,row.names=TRUE,
      col.names=c("VIF", "Degrees of Freedom", "Scaled VIF"),format="html",booktabs=T,
...
```{r echo=FALSE, fig.width=8, fig.height=4, fig.align="center", out.width="80%", message=FALSE}
...
kable(mat3v3,row.names=TRUE,
      col.names=c("Odds Ratio", "Log Odds Estimate", "Standard Error", "Statistic",
                  "p-value"),format="html",booktabs=T,
      caption="**Predicting Players' Average Ranks**") %>%
  kable_styling(position="center",latex_options = c("hold_position"))
...
[4] Deruite Stacy (2022), retrieved December 2, 2022 from: https://stacyderuiter.github.io/s245-notes-bookdown/collinearity-and-multicollinearity.html
